...
export function Contact() {
  ...
  const items = [
    { key: "email", label: "邮箱", value: contact.email, href: `mailto:${contact.email}` },
    ...
    { key: "wechat", label: "微信", value: contact.wechat },
  ].filter((item) => item.value)

  return (
    <SectionWrapper id="contact" title="联系我" subtitle="欢迎随时联系">
